...
use App\Http\Controllers\Backend\InstallmentSaleController;
...
Route::prefix('admin')->as('backend.admin.')->middleware(['admin'])->group(function () {
   ...
   // start pos
    ...
    Route::get('salesman/assignment', [InstallmentSaleController::class, 'salesmanAssignment'])->name('salesman.assignment');
    Route::get('salesman/print-list/{id}', [InstallmentSaleController::class, 'printList'])->name('salesman.print.list');
    
    // API routes for salesman assignment
