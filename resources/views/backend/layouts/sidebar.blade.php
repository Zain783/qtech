...
<div class="sidebar">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            {{-- Installment Sales --}}
            <li class="nav-item">
                <a href="#" class="nav-link {{ request()->routeIs(['backend.admin.installment.sales', 'backend.admin.installment.sales.show', 'backend.admin.installment.sales.payment']) ? 'menu-open' : '' }}">
